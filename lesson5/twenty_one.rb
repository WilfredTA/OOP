...
# Two types of nouns: Those that perform actions and those that don't:
# Those that don't
# perform actions are not classes, but attributes of classes; it's not a noun
# that performs
...
module Hand
  ...
  def better_hand_than?(other)
    if bust?
      ...
      (21 - total_with_ace_correction.abs) <
        (21 - other.total_with_ace_correction.abs)
    end
  end
